...
<template>
  <BaseSection :content="content" v-slot="{ uiProps }">
    <section
      class="factory-section relative w-full py-16 sm:py-20 lg:py-24"
...
.factory-section :deep(.splide__pagination__page) {
  width: 24px;
  height: 4px;
...
.factory-section :deep(.splide__pagination__page.is-active) {
  opacity: 1;
  transform: none;
}
.factory-section :deep(.splide__arrow) {
...
.factory-section :deep(.splide__arrow:hover) {
